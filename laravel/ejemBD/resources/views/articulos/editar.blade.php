...
@section('page-title', 'Editar ' . $articulo->nombre)
            ...
            <div class="row mt-4">
                <div class="input-field col-sm-12">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control">
                        {{ old('descripcion') ?: $articulo->descripcion }}
                    </textarea>
                </div>
            </div>
            <div class="row mt-4">
                ...
                <div class="input-field col-sm-4 text-center">
                    ...
                    <div class="btn-group" aria-label="Basic radio toggle button group" role="group">
                        ...
                        <input type="radio" class="btn-check" name="envio" id="envio2" autocomplete="off"
                            value="S"
                            {{ old('envio') == 'S' ? 'checked' : ($articulo->envio == 'S' ? 'checked' : '') }}>
            ...
            <div class="row mt-4">
                <div class="input-field col-sm-12">
                    ...
                    <textarea name="observaciones" id="observaciones" class="form-control">
                        {{ old('observaciones') ?: $articulo->observaciones }}
                    </textarea>
                </div>
            </div>
            <div class="row mt-4">
